...
class ChuckInterceptor(context: Context) : Interceptor {
     ...
     * @return The [ChuckInterceptor] instance.
     */
    ...
    private fun create(transaction: HttpTransaction): Uri {
        ...
        val uri = context.contentResolver.insert(ChuckContentProvider.TRANSACTION_URI, values)
    ...
    companion object {
        ...
        private const val LOG_TAG = "ChuckInterceptor"
