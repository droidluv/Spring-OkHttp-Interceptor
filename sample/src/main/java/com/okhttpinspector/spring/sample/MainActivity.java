/*
 * Copyright (C) 2019 SebiSheldin Sebastian.
 *
 ...
 */
package com.okhttpinspector.spring.sample;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        findViewById(R.id.launch_spring_activity).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(Spring.INSTANCE.getLaunchIntent(MainActivity.this));
            }
        });
    }
    ...
    private OkHttpClient getClient(Context context) {
        return new OkHttpClient.Builder()
                // Add a SpringInterceptor instance to your OkHttp client
